const GoldenLeavesCard = () => {
  return (
    <div className="section-margin rounded-2xl text-center p-4 md:px-[80px] xl:px-[165px] md:py-[60px] xl:py-[135px] bg-[url('/assets/images//golden-leaves-card-bg.png')] bg-no-repeat bg-cover relative">
