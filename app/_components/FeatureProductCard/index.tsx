  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-4 xl:gap-[40px] flex-wrap">
      ...
      <div className="flex-1">
        ...
        <p className="pb-10">
          Indulge your hair in pure luxaury with our Silk Elegance Conditioner.
          This rich, hydrating formula, blend with gold extracts, leaves your
          hair silky-smooth and beautifully conditioned.
        </p>
