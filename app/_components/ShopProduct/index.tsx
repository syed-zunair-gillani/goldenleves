...
const ShopProduct = (props: IShopProduct) => {
  ...
  return (
    <div
      className={` flex items-center flex-col-reverse lg:flex-row gap-10 xl:gap-[80px] bg-[#111] rounded-2xl px-8 lg:px-[60px] m-[80px] section-margin pb-8 lg:pb-0 ${
        direction === "reverse" ? "lg:!flex-row-reverse" : "flex-col"
      }`}
    >
      <div className="md:pb-10 md:pt-7 lg:pt-10 lg:pb-14 basis-full xl:basis-[55%]">
        <h2 className="relative section-heading-44 uppercase font-normal golden-gradient-text">
          ...
          <motion.span
            ...
            viewport={{ once: true }}
            className={`absolute bg-[#111111] inset-0`}
          ></motion.span>
        </h2>
