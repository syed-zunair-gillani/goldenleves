...
const ProductCard = ({
  ...
  return (
    <div className="flex flex-col items-center gap-5 bg-[#111111] px-6 md:px-[62px] py-10 rounded-3xl max-w-[472px]">
      <p className="golden-gradient-text text-xl md:text-[40px] md:leading-[50px] text-center">
        {title}
      </p>
      <div className="flex-1">
        <Image src={image} alt="product" width={256} height={420} />
      </div>
